...
export async function get(req, res) {
	const a1__name = await readdir('src/routes/g/_content')
	const a1__promise__stats =
		map(a1__name, name => lstat('src/routes/g/_content'))
	...
	const a1__path__root__content =
		map(a1__name__root__content, name__root__content => `/g/${name__root__content}`)
	const headers = {
